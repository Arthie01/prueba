...
2. Genera en tu API los endpoints necesarios para cumplir con:
...
buscar libro por nombre: http://127.0.0.1:8000/v1/libros/buscar/?titulo=principito
...
devolver un libro: http://127.0.0.1:8000/v1/libros/2/devolver/
...
eliminar un libro: http://127.0.0.1:8000/v1/libros/1/
...
================================================================================
DOCKERIZACIÓN - PASOS COMPLETOS
================================================================================

1. PREPARAR ARCHIVOS NECESARIOS
--------------------------------
cd /home/artemio/prueba/miAPILibro
...
------------------------
docker run -d -p 8000:8000 --name mi-api-biblioteca api-biblioteca
docker ps
...
-------------------------------
docker logs mi-api-biblioteca
docker logs -f mi-api-biblioteca
...
docker stop mi-api-biblioteca      # Detener contenedor
docker restart mi-api-biblioteca   # Reiniciar contenedor
docker rm mi-api-biblioteca        # Eliminar contenedor
docker rmi api-biblioteca          # Eliminar imagen
...
# Nombre de contenedor ya existe
docker rm mi-api-biblioteca

# Reconstruir desde cero
docker stop mi-api-biblioteca
docker rm mi-api-biblioteca
docker rmi api-biblioteca
docker build -t api-biblioteca .
docker run -d -p 8000:8000 --name mi-api-biblioteca api-biblioteca
...
FLUJO RÁPIDO PARA EL EXAMEN:
-----------------------------
1. cd /home/artemio/prueba/miAPILibro
2. nano Dockerfile (copiar contenido)
3. docker build -t api-biblioteca .
4. docker run -d -p 8000:8000 --name mi-api-biblioteca api-biblioteca
5. docker ps
6. curl http://localhost:8000/docs
7. docker logs mi-api-biblioteca (si hay error)
